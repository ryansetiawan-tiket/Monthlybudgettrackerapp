import svgPaths from "./svg-1uwu4wg7of";
...
export default function Card() {
  return (
    <div className="bg-neutral-950 relative rounded-[14px] size-full" data-name="Card">
      ...
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[27px] items-start pb-[0.502px] pl-[24.499px] pr-[0.502px] pt-[24.499px] relative size-full">
          <CardTitle />
